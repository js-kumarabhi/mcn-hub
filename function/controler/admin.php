...
$query =  "INSERT INTO `admin`(`adminName`, `adminPass`, `fullName`, `pic`, `collegeCode`, `collegeName`) VALUES ('$admin','$password','$name','$pic','$code','$clg')";
        ...
        <div class="nav-left-sidebar sidebar-dark">
            ...
            <div class="dashboard-wrapper">
                <div class="dashboard-ecommerce">
                    <div class="container-fluid dashboard-content ">
                        ...
                        <form method="POST" action="admin.php">
                         ...
                         <div class="form-group">
                            <input class="form-control form-control-lg" type="text" name="admin" required="" placeholder="Admin Name" autocomplete="off">
                        </div>

                        <div class="form-group">
                            <input class="form-control form-control-lg" type="text" name="password" required="" placeholder="Admin Password" autocomplete="off">
                        </div>
                        ...
                        <div class="form-group">
                            <input class="form-control form-control-lg" type="text" name="pic" required="" placeholder="Pic" autocomplete="off">
                        </div>
                    ...
                    <input type="submit" name="add" placeholder="Create" class=" btn btn-primary btn-md" value="Create" >
