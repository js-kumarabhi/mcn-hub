...
if(isset($_POST['onboard'])){
    ...
    $University=$_POST['uwebsite'];

$query =  "INSERT INTO `college_list`( `collegeName`, `collegeCode`, `collegeLogo`, `collegeWebsite`, `collegeLocation`, `universityWebsite`, `banner`) VALUES ('$clg','$code','$logo','$website', '$address','$University','$banner')";
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header">
                                    <h2 class="pageheader-title">Onboard New College</h2>
                        ...
                        <form method="POST" action="college.php">
                           <div class="card-body">
                            <div class="form-group">
                                <input class="form-control form-control-lg" type="text" name="clg" required="" placeholder="College Name" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input class="form-control form-control-md" type="text" name="address" required="" placeholder="College Location" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input class="form-control form-control-md" type="text" name="code" required="" placeholder="College Code" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input class="form-control form-control-md" type="text" name="website" required="" placeholder="College Website" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input class="form-control form-control-md" type="text" name="uwebsite" required="" placeholder="University Website" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <input class="form-control form-control-md" type="text" name="logo" required="" placeholder="Logo" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input class="form-control form-control-md" type="text" name="banner" required="" placeholder="Banner" autocomplete="off">
                            </div>
                        </div>
                        <input type="submit" name="onboard" placeholder="Create" class=" btn btn-primary btn-md" value="Add" >
                    </form>
