...
$query =  "INSERT INTO `librarian`(`username`, `password`, `firstname`, `lastname`, `photo`, `collegeCode`) VALUES ('$username','$password','$fname','$lname','$photo','$code')";
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="home.php">MCN</a>
                        ...
                        <div class="ecommerce-widget">
                            ...
                            <form method="Post" action="librarian.php">
                               ...
                               <div class="form-group">
                                <input class="form-control form-control-lg" type="text" name="librarian" required="" placeholder="UserName" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group">
                                <input class="form-control form-control-lg" type="text" name="lnamme" required="" placeholder="Last Name" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <input class="form-control form-control-lg" type="text" name="code" required="" placeholder="College Code" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <input class="form-control form-control-lg" type="text" name="photo" required="" placeholder="photo" autocomplete="off">
                            </div>

                            <input type="submit" name="Create" placeholder="Create" class=" btn btn-primary btn-md" value="Add New" align="dropdown-menu-right">
                        </form>          
                    </div>
